...
function buildForm(p: PmsEmployeeDetails | null, empCode: string, fallbackUser: UserType): FormData {
  ...
  return {
    ...
    baseCity:         pick(p, 'present_city', 'PresentCity', 'current_city', 'CurrentCity',
                          'city_name', 'CityName', 'city', 'City', 'base_city', 'BaseCity', 'work_city', 'WorkCity'),
    state:            pick(p, 'present_state', 'PresentState', 'current_state', 'CurrentState',
                          'state_name', 'StateName', 'state', 'State', 'province', 'Province'),
    country:          pick(p, 'present_country', 'PresentCountry', 'current_country', 'CurrentCountry',
                          'country_name', 'CountryName', 'country', 'Country', 'nationality', 'Nationality'),
    // Only pick explicitly "present/current/communication" address fields.
    // Do NOT fall back to generic 'address'/'Address' — those hold permanent address in Koenig PMS.
    address:          pick(p,
                          'present_address', 'PresentAddress', 'present_address_details', 'PresentAddressDetails',
                          'curr_address', 'CurrAddress', 'current_address', 'CurrentAddress',
                          'current_address_details', 'CurrentAddressDetails',
                          'communication_address', 'CommunicationAddress',
                          'local_address', 'LocalAddress', 'temp_address', 'TempAddress',
                          'temporary_address', 'TemporaryAddress', 'office_address', 'OfficeAddress'),
    pinCode:          pick(p,
                          'present_pin_code', 'PresentPinCode', 'present_pincode', 'PresentPincode',
                          'curr_pin_code', 'CurrPinCode', 'current_pin_code', 'CurrentPinCode',
                          'current_pincode', 'CurrentPincode', 'communication_pincode', 'CommunicationPincode',
                          'local_pin_code', 'LocalPinCode', 'temp_pincode', 'TempPincode',
                          'address_pin_code', 'AddressPinCode', 'pin_code', 'PinCode',
    ...
    accountNumber:    pick(p, 'bank_account', 'bank_account_no', 'BankAccountNo',
                          'account_number', 'AccountNumber', 'account_no', 'AccountNo',
                          'acc_no', 'AccNo', 'account', 'Account'),
    ifsc:             pick(p, 'ifsc_code', 'bank_ifsc_code', 'BankIfscCode', 'IfscCode',
