...
function buildForm(p: PmsEmployeeDetails | null, empCode: string, fallbackUser: UserType): FormData {
  ...
  return {
    ...
    // Present/current address takes priority over permanent address
    address:          pick(p,
                          'present_address', 'PresentAddress', 'present_address_details', 'PresentAddressDetails',
                          'current_address', 'CurrentAddress', 'current_address_details', 'CurrentAddressDetails',
                          'communication_address', 'CommunicationAddress',
                          'local_address', 'LocalAddress',
                          'address_details', 'AddressDetails', 'address', 'Address',
                          'residential_address', 'ResidentialAddress',
                          'permanent_address', 'PermanentAddress', 'addr', 'Addr'),
    pinCode:          pick(p,
                          'present_pin_code', 'PresentPinCode', 'present_pincode', 'PresentPincode',
                          'current_pin_code', 'CurrentPinCode', 'current_pincode', 'CurrentPincode',
